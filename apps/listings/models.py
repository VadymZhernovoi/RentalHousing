...
class Listing(TimeStampedModel):
    ...
    rooms = models.PositiveIntegerField(default=1, verbose_name=_("Rooms"))
    guests_max = models.PositiveIntegerField(default=0, verbose_name=_("Max Guests"))
    baby_crib_max = models.PositiveIntegerField(default=0, verbose_name=_("Max Baby Cribs"))
